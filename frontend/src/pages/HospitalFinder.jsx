...
import { BiSearch, BiCurrentLocation, BiCheck, BiBuildings, BiClinic, BiMapPin, BiFilter } from 'react-icons/bi';
...
const TABS = [
  { key: 'all', label: 'All', icon: BiFilter },
...
const HospitalFinder = () => {
  ...
  const handleSearchSubmit = (e) => {
    ...
    setDebouncedQuery(query.trim());
    const params = { query: query.trim(), type: filters.type };
    if (filters.lat) { params.lat = filters.lat; params.lng = filters.lng; params.radius = filters.radius; }
    performSearch(params);
  };
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      <div className="mb-8 text-center">
        ...
        <p className="section-subtitle mb-0">Find nearby hospitals and blood banks with blood stock information</p>
      </div>
      ...
      <div className="mt-4">
        ...
        {!loading && searched && count === 0 && (
          <div className="card py-16 text-center">
            ...
            <p className="mt-2 text-sm text-gray-400">
              {query.trim()
                ? `No hospitals or blood banks found matching "${query.trim()}". Try a different search term.`
                : hasLocation
                  ? 'No results near your location. Try increasing the search radius.'
                  : 'Enter a location above to search.'}
            </p>
          </div>
        )}
        ...
        {!searched && !loading && (
          <div className="card py-16 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400">Search for hospitals and blood banks near you</p>
